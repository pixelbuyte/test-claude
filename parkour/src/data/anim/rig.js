...
export const BONES = [
  ...
  { name: 'chest', parent: BONE.SPINE, offset: [0, 0.20, 0], size: [0.50, 0.50, 0.31], part: 'primary', shape: 'capsule' },
  ...
  { name: 'head', parent: BONE.CHEST, offset: [0, 0.17, 0], size: [0.38, 0.36, 0.36], part: 'skin', shape: 'sphere' },
  ...
  { name: 'armL', parent: BONE.CHEST, offset: [-0.28, -0.05, 0], size: [0.155, 0.25, 0.155], part: 'primary', shape: 'capsule' },
  { name: 'forearmL', parent: BONE.ARM_L, offset: [0, -0.24, 0], size: [0.14, 0.23, 0.14], part: 'primary', shape: 'capsule', cap: { radius: 0.105, part: 'accent' } },
  { name: 'armR', parent: BONE.CHEST, offset: [0.28, -0.05, 0], size: [0.155, 0.25, 0.155], part: 'primary', shape: 'capsule' },
  { name: 'forearmR', parent: BONE.ARM_R, offset: [0, -0.24, 0], size: [0.14, 0.23, 0.14], part: 'primary', shape: 'capsule', cap: { radius: 0.105, part: 'accent' } },

  { name: 'thighL', parent: BONE.HIPS, offset: [-0.115, -0.15, 0], size: [0.19, 0.29, 0.19], part: 'primary', shape: 'capsule' },
  { name: 'shinL', parent: BONE.THIGH_L, offset: [0, -0.29, 0], size: [0.165, 0.27, 0.165], part: 'primary', shape: 'capsule' },
  { name: 'thighR', parent: BONE.HIPS, offset: [0.115, -0.15, 0], size: [0.19, 0.29, 0.19], part: 'primary', shape: 'capsule' },
  { name: 'shinR', parent: BONE.THIGH_R, offset: [0, -0.29, 0], size: [0.165, 0.27, 0.165], part: 'primary', shape: 'capsule' },
  ...
  { name: 'footL', parent: BONE.SHIN_L, offset: [0, -0.27, 0.04], size: [0.175, 0.11, 0.25], part: 'accent', shape: 'box' },
  { name: 'footR', parent: BONE.SHIN_R, offset: [0, -0.27, 0.04], size: [0.175, 0.11, 0.25], part: 'accent', shape: 'box' },
];
